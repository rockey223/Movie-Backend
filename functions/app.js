...
app.patch("/.netlify/functions/seat/movie/:movieId", async (req, res) => {
  console.log(req.body);
  var ida = "";
  try {
...
// paisdfasdfg
app.post("/.netlify/functions/seat/movie/:movieId", async (req, res) => {
  try {
    console.log(req.body);
    const { movieId, seats } = req.body;
...
app.get("/.netlify/functions/seats", async (req, res) => {
  try {
...
app.get("/.netlify/functions/seat/movie/:movieId", async (req, res, next) => {
  try {
...
app.post("/.netlify/functions/reserveSeat", async (req, res) => {
  try {
    console.log(req.body);
...
app.post("/.netlify/functions/upload", (req, res) => {
  console.log(req.body);
  upload(req, res, (err) => {
    if (err) {
...
app.get("/.netlify/functions/movie", async (req, res) => {
  try {
...
app.get("/.netlify/functions/user", async (req, res) => {
  try {
